...
plot(L, w_opt(name2idx(ra.Channels.PC_RED))*S(:,name2idx(ra.Channels.PC_RED)), 'Color', [155/255 0/255 0/255]);
...
plot(L, w_opt(name2idx(ra.Channels.AMBER))*S(:,name2idx(ra.Channels.AMBER)), 'Color', [255/255 198/255 0/255]);

resultSpectrum = ... % Тут можно не перечислять, а пробежаться сразу по индексам names, а так каждый раз вручную спектры добавлять
    ...
    w_opt(name2idx(ra.Channels.PC_RED))*S(:,name2idx(ra.Channels.PC_RED)) + ...
    ...
    w_opt(name2idx(ra.Channels.AMBER))*S(:,name2idx(ra.Channels.AMBER));
...
P = w_opt(name2idx(ra.Channels.WARM2700))*ra.getParam(names, Params, ra.Channels.WARM2700, ra.LedParam.P) + ...
    ...
    w_opt(name2idx(ra.Channels.PC_RED))*ra.getParam(names, Params, ra.Channels.PC_RED, ra.LedParam.P) + ...
    ...
    w_opt(name2idx(ra.Channels.AMBER))*ra.getParam(names, Params, ra.Channels.AMBER, ra.LedParam.P);
